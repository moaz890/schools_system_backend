...
export class UpdateSchoolStrategyDto {
  ...
  @ApiPropertyOptional({
    example: false,
    description: 'Round final grade totals?',
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    example: 0,
    description: 'Decimal places in grade display (0, 1, or 2)',
  })
  @IsOptional()
  @IsInt()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: true,
    description:
      'Must student pass the final exam to pass the subject? (Dour Thani logic)',
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Does this school offer resit/makeup exams?',
  })
  @IsOptional()
  @IsBoolean()
  allowResit?: boolean;
  ...
  @ApiPropertyOptional({
    example: 2,
    description:
      'Max failed subjects for resit eligibility. Fail more than this → repeat year.',
  })
  @IsOptional()
  @IsInt()
  @Min(0)
