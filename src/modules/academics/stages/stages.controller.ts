...
export class StagesController {
  ...
  @Roles(UserRole.SCHOOL_ADMIN)
  @ApiOperation({
    summary: 'Soft delete a stage and its grades (school_admin only)',
  })
  remove(
    @Param('id', ParseUUIDPipe) id: string,
    @CurrentUser() caller: AuthCaller,
  ...
  @Roles(UserRole.SCHOOL_ADMIN)
  @ApiOperation({
    summary: 'List stages for current school (school_admin only)',
  })
  ...
  @Roles(UserRole.SCHOOL_ADMIN)
  @ApiOperation({
    summary: 'Get one stage with grade levels (school_admin only)',
  })
  get(
    @Param('id', ParseUUIDPipe) id: string,
    @CurrentUser() caller: AuthCaller,
