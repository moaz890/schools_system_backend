...
import {
  getLogoMulterOptions,
  getPublicLogoUrl,
} from '../../../common/upload/logo-upload.helper';
import {
  ApiBearerAuth,
  ApiConsumes,
  ApiOperation,
...
export class SchoolsController {
  ...
  @Roles(UserRole.SUPER_ADMIN)
  @ApiOperation({
    summary: 'Cross-school analytics (Super Admin only, placeholder)',
  })
  getAnalytics() {
  ...
  @ApiOperation({
    summary: "Get current user's school (no need to know the ID)",
  })
