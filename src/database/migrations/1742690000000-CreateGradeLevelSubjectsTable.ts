...
export class CreateGradeLevelSubjectsTable1742690000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS UQ_grade_level_subjects_pair`);
        await queryRunner.query(`DROP INDEX IF EXISTS IDX_grade_level_subjects_subject_id`);
        await queryRunner.query(`DROP INDEX IF EXISTS IDX_grade_level_subjects_grade_level_id`);
